...
Shader::Shader(const std::string& vertex_filename, const std::string& fragment_filename) : id_(0)
{
	const auto vertex_path = std::filesystem::current_path() / "src/shaders" / vertex_filename;
	const auto fragment_path = std::filesystem::current_path() / "src/shaders" / fragment_filename;
